...
1. **Через GitHub**.
    ...
    |`A_1` | содержимое файла authorized_key (авторизованный ключ) |
    |`SSH_KEY` | приватный SSH ключ |

    При таком способе выполняя команду `git push origin`, в зависимости от желаемого состояния будет запускаться pipeline.
<br>
</br>
